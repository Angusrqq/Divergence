...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        /// </summary>
        public void UpdateBindingDisplay(string text = null)
        {
        ...
        public void StartInteractiveRebind()
        {
            ...
            m_WaitCoroutine = StartCoroutine(WaitForKeyAnimation());
        }
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            void CleanUp()
            {
                ...
                if(m_RebindButtonsHolder != null)
                {
                    foreach(Button button in m_RebindButtonsHolder.GetComponentsInChildren<Button>())
                    {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        m_RebindStopEvent?.Invoke(this, operation);
                        UpdateBindingDisplay();
                        GameData.SaveBindings(m_Action.asset);
                        CleanUp();
        ...
        protected void OnEnable()
        {
            ...
            GameData.LoadBindings(m_Action.asset);
        }
        ...
        [Tooltip("Optional holder for buttons that won't be interactable while a rebind is in progress.")]
        [SerializeField]
        private GameObject m_RebindButtonsHolder;
        ...
        private void UpdateActionLabel()
        {
            ...
            {
                var action = m_Action?.action;
                InputBinding bind = action.bindings.FirstOrDefault(x => x.id.ToString() == m_BindingId);
                if(bind.isPartOfComposite == true)
                {
                    m_ActionLabel.text = bind.name[0].ToString().ToUpper() + bind.name[1..]; // capitalize first letter
                    return;
                }
        ...
        private IEnumerator WaitForKeyAnimation()
        {
            ...
            while (true)
            {
                UpdateBindingDisplay(string.Concat(Enumerable.Repeat(".", counter)));
                counter++;
                if(counter >= 4)
                {
                    counter = 0;
