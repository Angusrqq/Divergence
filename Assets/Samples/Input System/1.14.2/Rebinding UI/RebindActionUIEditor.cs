...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_RebindButtonsHolderProperty = serializedObject.FindProperty("m_RebindButtonsHolder");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_RebindButtonsHolderProperty);
        ...
        private SerializedProperty m_RebindButtonsHolderProperty;
